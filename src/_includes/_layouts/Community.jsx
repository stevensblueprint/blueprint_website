    ...
    <body>
      <>
        ...
        <section className="grid place-content-center">
          ...
          <h1 className="text-5xl mb-8">Become part of our Blueprint community!</h1>
          <p className="text-xl mb-16 text-center max-w-3xl">
              Whether you’re a student at Stevens looking for a place to make an impact with design, development, or management, 
              or a representative of a non-profit organization hoping for a technology solution, we’re the place for you!
            </p>
            <div className="w-full flex justify-center space-x-10 max-md:flex-col max-md:space-x-0 max-md:space-y-4">
              <div className="basis-1/3 flex flex-col m-2 p-4 max-md:items-start max-md:p-0s border border-black rounded-lg max-w-xl">
                <h2 className="text-2xl mb-3 mt-4">
                  Students
                </h2>
