                ...
                <ol class="flex flex-col p-10 md:flex-row md:divide-x md:divide-charcoal-500 space-y-5 md:space-y-0">
                  <li class="flex-1 flex flex-col p-6 space-y-4 md:pr-6">
                    <div class="relative w-16 h-16 mb-3">
                      <h1 class="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-10 row-start-1 text-blue text-[48px] font-medium">1</h1>
                    </div>
                    <h2 className="font-bold text-xl text-primary mb-2">
                      Written Application
                    </h2>
                    <p>
                      Attend our events and info sessions to learn more about our application cycle! In your written application, tell us about yourself 
                      and why you're interested in joining Blueprint. We anonymize your applications in this first stage, so please take care to be detailed 
                      so we have the most holistic perspective of you. Applications open Feb 26, 2024 12:00 AM and close Mar 05, 2024 11:59 PM.
                    </p>
                  </li>
  
                  <li class="flex-1 flex flex-col p-6 space-y-4 md:pr-6">
                    <div class="relative w-16 h-16 mb-3">
                      <h1 class="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-10 row-start-1 text-blue text-[48px] font-medium">2</h1>
                    </div>
                    <h2 className="font-bold text-xl text-primary mb-2">
                      Blueprint Games
                    </h2>
                    <p>
                      This semester, Blueprint Games will be hosted on Mar 20, 2024 3:00 PM (invites will be sent by Mar 08). The event is a team-based 
                      activity that simulates the product design and implementation process for a hypothetical client.
                    </p>
                  </li>
