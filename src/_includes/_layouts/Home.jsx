  ...
  return (
    <html>
      ...
      <body>
        ...
        <section className="h-screen flex flex-col items-center justify-center py-32 gap-y-20 max-lg:h-fit ">
          <h1 className="lg:text-5xl text-7xl">
        ...
        <section className="h-[17rem] bg-primary text-negative flex flex-col justify-evenly items-center justify-center py-32 max-lg:h-fit max-lg:gap-y-16 max-lg:py-16">
