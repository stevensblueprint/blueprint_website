...
export default function Navbar() {
    ...
    return (
        <nav className="flex items-center justify-center space-x-64 p-6 bg-primary">
            ...
            <div>
                <a href="/about" className="mr-4 text-xl text-white">About</a>
                <a href="/projects" className="mr-4 text-xl text-white">Projects</a>
                <a href="/apply" className="mr-4 text-xl text-white">Apply</a>
                <a href="/blog" className="text-xl text-white">Blog</a>
            </div>
        </nav>
    );
}