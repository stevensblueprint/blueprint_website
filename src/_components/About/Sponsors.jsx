  ...
  return (
    <section className="flex items-center justify-center">
      <div className="flex flex-col lg:items-center p-8 w-full">
        ...
        <comp.Button
          style={
            "mx-auto px-16 py-2 rounded-xl border-2 border-black text-black font-bold w-fit lg:text-xl hover:bg-primary hover:text-white hover:border-transparent transition-all"
          }
