...
export default function Sponsors({ comp, testimonial_1, testimonial_2 }) {
  return (
    <section className="flex flex-col items-center w-full px-8 lg:px-40 py-8">
      <p className="text-lg lg:text-xl text-center w-full lg:w-3/5">
      ...
      <div className="flex flex-col w-full">
        <div className="flex flex-col lg:flex-row w-full">
          <div className="lg:w-1/2">
            ...
            <ul className="list-disc pl-5 text-left">
              ...
              <li>Access to talented pool of student developers for recruitment</li>
        ...
        <div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="flex flex-col lg:w-1/2">
            ...
            <ul className="list-disc pl-5 text-left">
              <li>Cloud infrastructure and hosting services for development environments</li>
              <li>Premium development tools and APIs to enhance our capabilities</li>
              <li>Educational workshops and training for our student developers</li>
            </ul>
          </div>
        </div>
      </div>
