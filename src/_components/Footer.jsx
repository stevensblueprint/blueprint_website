                    ...
                    <div className="mb-6 md:mb-0">
                        ...
                        <div class="sm:flex sm:items-center sm:justify-between">
                            <div class="flex mt-6 space-x-10 sm:justify-center sm:mt-4">
                                ...
                                <a href={github_url} class="text-gray-500 hover:text-gray-300 dark:hover:text-white">
                                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
                                ...
                                <a href={instagram_url} class="text-gray-500 hover:text-gray-300 dark:hover:text-white">
                                    <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
