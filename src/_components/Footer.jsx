            ...
            {/*get background images*/}
              <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
                  <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 ">
                        <a href={blueprint_url} className="flex items-center">
                            ...
                            <span className="self-center text-3xl font-semibold font-poppins whitespace-nowrap text-white">blueprint</span>
                        </a>
                        <h3 className="my-5 text-white font-medium font-poppins">Technology for Social Good 
                        </h3>
                    ...
                    <div className="grid grid-cols-2 gap-20 sm:gap-60 sm:grid-cols-3 ">
                        <div>
                            <h2 className="mb-6  text-md font-semibold font- poppins text-white uppercase ">General</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-md font-semibold font- poppins text-white uppercase ">Students</h2>
                            <ul className="text-gray-300 font-medium">
                                <li className="mb-4 font- poppins">
                        ...
                        <div>
                            <h2 className="mb-6 text-md font-semibold font- poppins text-white uppercase ">Non-Profits</h2>
                            <ul className="text-gray-300 font-medium">
                                <li className="mb-4 font- poppins">
                ...
                <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-300 lg:my-5" />
                    <span class="block text-sm text-gray-300 sm:text-center ">© 2023 
