...
export default function Hero({ comp }) {
  return (
    <section className="grow flex flex-col min-h-[400px] lg:flex-row lg:items-center relative overflow-hidden bg-primary text-white">
      <div className="px-6 md:px-12 lg:px-20 py-8 md:py-16 lg:py-0">
        <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl leading-snug md:leading-[1.3] tracking-wide mb-4 md:mb-6 lg:mb-8 text-center lg:text-left">
        ...
        <div className="flex flex-col md:flex-row md:justify-center lg:justify-start space-y-4 md:space-y-0 md:space-x-6">
          <comp.Button
            style="h-10 px-6 md:px-8 py-4 rounded-md border border-white justify-center items-center gap-2 text-white font-semibold text-base md:text-lg inline-flex"
