  ...
  return (
    <section>
      ...
      <div className="flex justify-center pb-12">
        <comp.Button
          style={
            "block px-8 py-2 lg:rounded-md rounded-md border border-black text-black text-base leading-normal font-bold w-fit lg:text-base text-4xl hover:bg-primary hover:text-white transition-all"
          }
